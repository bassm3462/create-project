...
<div class="dashboard" style="position: fixed;width: 18%;height: 100%;background:#2b547e"> <!-- fk-->
  <div style="background:#4682b4;padding: 14px 3px;color:white;font-size: 15pt;text-align: center;text-shadow: 1px 1px 11px black"><!--medical store-->
...
<div class="marginLeft" >
  <div style="color:white;background:#2b547e" >
